...
public interface AppConstants extends DevTestProdConstants {
	...
	public final String DB_FIRST = "spreadsheet.db.first";
	public final String DB_LAST = "spreadsheet.db.last";
	public final String DB_TRACKER = "spreadsheet.db.tracker";
	public final String DB_TEST = "spreadsheet.db.test";
	public final String DB_PROD = "spreadsheet.db.prod";
	public final String	DB_DEV = "spreadsheet.db.dev";
	public final String DB_LOCAL = "spreadsheet.db.local";
	/**
	 * Property name for the path to store the spreadsheet files locally.
	 */
	public final String FILE_DIR = "spreadsheet."+DEV_PROD_TEST+".fileDirectory";
    
    /**
     * Property name for the location of the processed file log
     */
    public final String PROCESSED_FILE_LOG = "spreadsheet."+DEV_PROD_TEST+".logDirectory";
	...
	//public final String LAST_PART_DB = ".nrel.gov/spread_sheet"; 
	//public final String LAST_PART_TRACKERDB = ".*/tracker"; 
	//public final String TEST_DB = "jdbc:mysql://*/spread_sheet";
	//public final String PROD_DB = "jdbc:mysql://*/spread_sheet";
	//public final String DEV_DB = "jdbc:mysql://*/spread_sheet";
