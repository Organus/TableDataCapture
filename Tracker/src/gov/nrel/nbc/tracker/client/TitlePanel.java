...
public class TitlePanel extends Composite {
	...
	public TitlePanel() {
		...
		if (DevTestProdConstants.DISPLAY_MODE.equals(DevTestProdConstants.BIOMASS)) {
			version = new Label("V2.0 - Build 1,002 - Built on 2012/10/16 11:29");
			...
			img.setHeight("100px");
			img.setWidth("224px");
			version = new Label("Algae Customization - Build 1,002 - Built on 2012/10/16 11:29");		
			title = new Label(ALGAE_TITLE_STRING);
		} //else if (DevTestProdConstants.DISPLAY_MODE.equals(DevTestProdConstants.ALGAE)){
		//	img = new Image(SABC_LOGO_JPG);
		//	img.setHeight("70px");
		//	img.setWidth("184px");
		//	version = new Label("SABC Customization - Build 1,002 - Built on 2012/10/16 11:29");		
