...
private static final String SINGLE_QUOTE = "'";
	...
	public String db_biomass = "";
	public String db_algae = "";
	...
	public void getProperties() {
		...
		try {
			...
			if (DevTestProdConstants.DISPLAY_MODE.equals(DevTestProdConstants.BIOMASS)) {
				if (!DevTestProdConstants.CRADA.equals(DevTestProdConstants.NO_CRADA) && DevTestProdConstants.DEV_PROD_TEST.equals(DevTestProdConstants.PROD)) {
					// TODO Fix me!
					db_biomass = gov.nrel.nbc.security.client.AppConstants.INITIAL_PART_DB;
					db_biomass += gov.nrel.nbc.tracker.client.AppConstants.CRADA_DB_SERVER;
					db_biomass += "/" + rBundle.getString(DB_BIOMASS);
				}
				db_biomass = gov.nrel.nbc.security.client.AppConstants.INITIAL_PART_DB;
				db_biomass += gov.nrel.nbc.security.client.AppConstants.FIRST_PART_DB;
				db_biomass += DevTestProdConstants.DEV_PROD_TEST;
				db_biomass += "/" + rBundle.getString(DB_BIOMASS);
			}  else {
				db_algae = gov.nrel.nbc.security.client.AppConstants.INITIAL_PART_DB;
				db_algae += gov.nrel.nbc.security.client.AppConstants.FIRST_PART_DB;
				db_algae += DevTestProdConstants.DEV_PROD_TEST;
				db_algae += "/" + rBundle.getString(DB_ALGAE);
			}
