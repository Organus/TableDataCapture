...
public class TitlePanel extends Composite {
	...
	public TitlePanel() {
		...
		if (DevTestProdConstants.DISPLAY_MODE.equals(DevTestProdConstants.BIOMASS)) {
			...
			img.setHeight("100px");
			img.setWidth("280px");
			version = new Label("V2.0 - Build 841 - Built on 2012/02/23 10:58");		
			...
			img.setHeight("100px");
			img.setWidth("224px");
			version = new Label("Algae Customization - Build 841 - Built on 2012/02/23 10:58");		
			title = new Label(ALGAE_TITLE_STRING);
		} //else if (DevTestProdConstants.DISPLAY_MODE.equals(DevTestProdConstants.ALGAE)){
		//	img = new Image(SABC_LOGO_JPG);
		//	img.setHeight("70px");
		//	img.setWidth("184px");
		//	version = new Label("SABC Customization - Build 841 - Built on 2012/02/23 10:58");		
