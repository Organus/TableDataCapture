...
import gov.nrel.nbc.labelprinting.client.CreateSample.MySelectionHandler;
import gov.nrel.nbc.labelprinting.client.CreateSample.MyValueChangeHandler;
...
public class ModifySampleDialog extends DialogBox implements ClickHandler, AppConstants {
	...
	private void saveSample(boolean modify) {
		...
		if (destBox.getText() != null) {
			theSample.setDestination(destBox.getText());
		}
		
		if (this.strainBox.getText() != null) {
		...
		if (descriptorBox.isValid())
			theSample.setDescription(descriptorBox.replaceQuotes(descriptorBox.getValue()));
		else {
			...
			public void onSuccess(SampleCriteria result) {
				try {
					if (result != null) {
						...
						if (theSample != null && theSample.getDescription() != null && !theSample.getDescription().isEmpty()) {
							descriptorBox.setValue(theSample.getDescription());
