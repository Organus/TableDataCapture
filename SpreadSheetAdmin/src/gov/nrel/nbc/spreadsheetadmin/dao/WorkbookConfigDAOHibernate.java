...
public class WorkbookConfigDAOHibernate extends
	...
	private static final String WORKBOOK_FILE = "workbook_file";
	private static final String PATH = "path";
	private static final String CONFIG_NAME = "config_name";
	private static final String SYNONYM = "synonym";

	/**
	 * Public method to get a list of WorkbookConfigs.
	 * 
	 * @return <List<String>> - list of WorkbookConfig names.
	 */
	...
	/**
	 * Public method to get a WorkbookConfig by its name.
	 * 
	 * @param name String
	...
	/**
	 * Public method to get a WorkbookConfig by its synonym.
	 * 
	...
	/**
	 * Public method to get a WorkbookConfig using its name and a sheet name.
	 * 
	 * @param shConfigName String Sheet config name
	 * @param wbConfigName String Workbook config name
	 * @return WorkbookConfig.
	 */
	...
	/**
	 * Public method to get a WorkbookConfig from a SheetConfig.
	 * 
	 * @param sheet SheetConfig
	 * @return WorkbookConfig
	 */
	public WorkbookConfig findBySheet(SheetConfig sheet) {
		...
		while (wit.hasNext() && !found) {
			...
			while (sit.hasNext()) {
				SheetConfig sc = sit.next();
				if (sc.getSheet_config_id()==sheet.getSheet_config_id()) {
					found = true;
					wbc = wbc1;
					break;
				}
	...
	/**
	 * Public method to get a SheetConfig.
	 * 
	 * @param wbConfig String WorkbookConfig name
	 * @param sheet String SheetConfig name
	 * @return SheetConfig
	 */
	...
	/**
	 * Public method to find a file by its file path.
	 * 
	 * @param path String
	 * @return WorkbookFileData
	 */
    ...
    public long getNextId(){
    	...
    	Long l = (Long) getSession().createCriteria( getPersistentClass() ).setProjection( Projections.max( "workbook_config_id" )).uniqueResult();
    	if (l != null) id = l.longValue();
    	return id+1;
    }
	/**
	 * Public method to find a WorkbookConfig by its
	 *  file path.
	 * 
	 * @param path String
	 * @return WorkbookConfig
