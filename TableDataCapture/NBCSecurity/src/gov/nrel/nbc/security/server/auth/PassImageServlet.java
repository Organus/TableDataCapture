...
import com.temesoft.security.image.ISkewImage;
...
public class PassImageServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -1022024730274480383L;
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            //log.info("passedKeyStr="+passedKeyStr);
            ...
            String passstring = passedKeyStr;//Base64Coder.decode(passedKeyStr);

            passedKeyStr = passedKeyStr;//_stringEncrypter.decrypt(passstring);
