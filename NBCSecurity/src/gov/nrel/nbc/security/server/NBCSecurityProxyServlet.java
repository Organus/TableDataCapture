 ...
 */
public class NBCSecurityProxyServlet extends HttpServlet {
    ...
    public void init(ServletConfig servletConfig) {
    	log.info("in NBCSecurityProxyServlet.init");
        // Get the proxy host
        String stringProxyHostNew = servletConfig.getInitParameter("proxyHost");
        if (stringProxyHostNew == null || stringProxyHostNew.length() == 0) {
        	String codebase = this.getProxyHostAndPort();
        	
        	// Build the URL for the servlet 
        	//web server
        	URL servletBase = null;
        	try {
        		servletBase = new URL(codebase);
        	} catch (MalformedURLException mue) {}

        	log.info("path="+servletBase.getPath());
        	if (servletBase != null)
        		stringProxyHostNew=servletBase.getPath()+":"+servletBase.getPort();
        	else 
        		stringProxyHostNew="localhost:8881/NBCSecurity";//throw new IllegalArgumentException("Proxy host not set, please set init-param 'proxyHost' in web.xml");
        }
        log.info("new host="+stringProxyHostNew);
    ...
    public void doGet(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
    	...
    	log.info("in NBCSecurityProxyServlet.doGet");
        // Create a GET request
        destinationUrl = this.getProxyURL(httpServletRequest);
        requestUrl = httpServletRequest.getRequestURL().toString();
        debug("GET Request URL: " + httpServletRequest.getRequestURL(),
              "Destination URL: " + destinationUrl);
        String stringProxyHostNew = this.getProxyHost();
        int reqcolon = requestUrl.lastIndexOf(":");
        int index = reqcolon+5;
        stringProxyHostNew += requestUrl.substring(index);
        this.setProxyHost(stringProxyHostNew);
        destinationUrl += requestUrl.substring(index);
        httpServletRequest.setAttribute("destinationUrl", destinationUrl);
        log.info("new destination URL: "+this.getProxyURL(httpServletRequest));
    ...
    public void doPost(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
            throws IOException, ServletException {
    	log.info("in NBCSecurityProxyServlet.doPost");
    ...
    private void handleMultipartPost(PostMethod postMethodProxyRequest, HttpServletRequest httpServletRequest)
    	...
    	log.info("in NBCSecurityProxyServlet.handleMultipartPost");
    ...
    private void handleStandardPost(PostMethod postMethodProxyRequest, HttpServletRequest httpServletRequest) {
    	log.info("in NBCSecurityProxyServlet.handleStandardPost");
    ...
    private void handleContentPost(PostMethod postMethodProxyRequest, HttpServletRequest httpServletRequest) throws IOException, ServletException {
    	log.info("in NBCSecurityProxyServlet.handleContentPost");
    ...
    private void executeProxyRequest(
            ...
            throws IOException, ServletException {
    	log.info("in NBCSecurityProxyServlet.executeProxyRequest");
    ...
    private void setProxyRequestHeaders(HttpServletRequest httpServletRequest, HttpMethod httpMethodProxyRequest) {
    	log.info("in NBCSecurityProxyServlet.setProxyRequestHeaders");
    ...
    private void setProxyRequestCookies(HttpServletRequest httpServletRequest, HttpMethod httpMethodProxyRequest) {
    	log.info("in NBCSecurityProxyServlet.setProxyRequestCookies");
    ...
    protected String getProxyURL(HttpServletRequest httpServletRequest) {
    	log.info("in NBCSecurityProxyServlet.getProxyURL");
